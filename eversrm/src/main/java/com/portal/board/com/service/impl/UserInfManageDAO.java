 ...
 * </pre>
 */
@Repository("UserInfManageDAO")
public class UserInfManageDAO extends EgovAbstractMapper {
    ...
    public List<UserInfVO> selectUserList(UserInfVO userVO) throws Exception {
    	return selectList("UserInfManageDAO.selectUserList", userVO);
    }
    ...
    public int selectUserListCnt(UserInfVO userVO) throws Exception {
    	return (Integer)selectOne("UserInfManageDAO.selectUserListCnt", userVO);
    }
    ...
    public List<UserInfVO> selectCmmntyUserList(UserInfVO userVO) throws Exception {
    	return selectList("UserInfManageDAO.selectCmmntyUserList", userVO);
    }
    ...
    public int selectCmmntyUserListCnt(UserInfVO userVO) throws Exception {
    	return (Integer)selectOne("UserInfManageDAO.selectCmmntyUserListCnt", userVO);
    }
    ...
    public List<UserInfVO> selectCmmntyMngrList(UserInfVO userVO) throws Exception {
    	return selectList("UserInfManageDAO.selectCmmntyMngrList", userVO);
    }
    ...
    public int selectCmmntyMngrListCnt(UserInfVO userVO) throws Exception {
    	return (Integer)selectOne("UserInfManageDAO.selectCmmntyMngrListCnt", userVO);
    }
    ...
    public List<UserInfVO> selectClubUserList(UserInfVO userVO) throws Exception {
    	return selectList("UserInfManageDAO.selectClubUserList", userVO);
    }
    ...
    public int selectClubUserListCnt(UserInfVO userVO) throws Exception {
    	return (Integer)selectOne("UserInfManageDAO.selectClubUserListCnt", userVO);
    }
    ...
    public List<UserInfVO> selectClubOprtrList(UserInfVO userVO) throws Exception {
    	return selectList("UserInfManageDAO.selectClubOprtrList", userVO);
    }
    ...
    public int selectClubOprtrListCnt(UserInfVO userVO) throws Exception {
    	return (Integer)selectOne("UserInfManageDAO.selectClubOprtrListCnt", userVO);
    }
    ...
    public List<UserInfVO> selectAllClubUser(UserInfVO userVO) throws Exception {
    	return selectList("UserInfManageDAO.selectAllClubUser", userVO);
    }
    ...
    public List<UserInfVO> selectAllCmmntyUser(UserInfVO userVO) throws Exception {
    	return selectList("UserInfManageDAO.selectAllCmmntyUser", userVO);
    }
}
