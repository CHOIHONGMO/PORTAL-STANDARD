...
public class MultipartResolver extends StandardServletMultipartResolver {
	...
	private void validateUploadedFiles(MultipartHttpServletRequest multipartRequest) throws SecurityException {
		...
		String whiteListFileUploadExtensions = PortalProperties.getProperty("Globals.fileUpload.Extensions");
	...
	private int getMaxFileCount() {
		String maxFileCountStr = PortalProperties.getProperty("Globals.fileUpload.maxFileCount");
	...
	private long getMaxFileSize() {
		String maxFileSizeStr = PortalProperties.getProperty("Globals.fileUpload.maxFileSize");
