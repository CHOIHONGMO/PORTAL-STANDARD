package egovframework.let.api.cop.bbs.web;
...
@RestController
@RequestMapping("/api/cop/bbs")
public class EgovBBSApiManageController {
    ...
    public Map<String, Object> insertBoardArticle(@org.springframework.web.bind.annotation.RequestBody egovframework.let.cop.bbs.service.Board board) throws Exception {
        Map<String, Object> response = new HashMap<>();
        try {
    ...
    public Map<String, Object> updateBoardArticle(@org.springframework.web.bind.annotation.RequestBody egovframework.let.cop.bbs.service.Board board) throws Exception {
        Map<String, Object> response = new HashMap<>();
        try {
            if(board.getBbsId() == null || board.getBbsId().isEmpty()) {
                board.setBbsId("BBSMSTR_AAAAAAAAAAAA");
    ...
    public Map<String, Object> deleteBoardArticle(@org.springframework.web.bind.annotation.RequestBody egovframework.let.cop.bbs.service.Board board) throws Exception {
        Map<String, Object> response = new HashMap<>();
        try {
            if(board.getBbsId() == null || board.getBbsId().isEmpty()) {
                board.setBbsId("BBSMSTR_AAAAAAAAAAAA");
