package egovframework.let.api.uss.olp.web;
...
public class EgovQustnrApiManageController {
    ...
    private EgovQustnrQestnManageService qustnrQestnManageService;

    @Autowired
    @Qualifier("egovQustnrItemManageService")
    private EgovQustnrItemManageService qustnrItemManageService;

    @Autowired
    @Qualifier("egovQustnrRespondInfoService")
    private EgovQustnrRespondInfoService qustnrRespondInfoService;

    @Autowired
    @Qualifier("egovQustnrRespondManageService")
    private EgovQustnrRespondManageService qustnrRespondManageService;

    @Autowired
    @Qualifier("egovQustnrTmplatManageService")
    private EgovQustnrTmplatManageService qustnrTmplatManageService;
