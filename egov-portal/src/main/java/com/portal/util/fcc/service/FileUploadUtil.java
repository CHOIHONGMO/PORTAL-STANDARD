package com.portal.util.fcc.service;
...
public class FileUploadUtil extends FormBasedFileUtil {
	 ...
	 * @throws Exception
	 */
	public static List<FormBasedFileVo> uploadFiles(HttpServletRequest request, String where, long maxFileSize)
		throws Exception {
				...
				if(tmp != null) {//2022.01 Possible null pointer dereference due to return value of called method
					...
					if (mFile.getSize() > 0) {
						...
						try {
							...
							saveFile(is, new File(WebUtil.filePathBlackList(
