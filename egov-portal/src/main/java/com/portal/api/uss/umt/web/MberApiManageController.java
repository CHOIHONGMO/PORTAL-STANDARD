package com.portal.api.uss.umt.web;
...
import com.portal.user.umt.service.MberManageService;
import com.portal.user.umt.service.MberManageVO;
import com.portal.user.umt.service.UserDefaultVO;
import com.portal.util.sim.service.FileScrty;
import jakarta.annotation.Resource;

@RestController
@RequestMapping("/api/uss/umt")
public class MberApiManageController {
    ...
    public Map<String, Object> updatePassword(@RequestBody Map<String, String> requestBody) throws Exception {
        ...
        try {
            ...
            if (encryptPass.equals(resultVO.getPassword())) {
                mberManageVO.setPassword(FileScrty.encryptPassword(newPassword, mberId));
