...
const QustnrRespondManageDetail = () => {
  ...
  const fetchDetailAndCodes = async () => {
    try {
      ...
      const [sexRes, jobRes, detailRes]: any[] = await Promise.all([
        ...
        apiClient.get(`/user/poll/qrm/selectQustnrRespondManageDetail.api?qestnrRespondId=${id}`)
      ]);
  ...
  const handleDelete = async () => {
    ...
    try {
      const response: any = await apiClient.post('/user/poll/qrm/deleteQustnrRespondManage.api', { qestnrRespondId: id });
