...
const QnaAnswerForm = () => {
  ...
  const fetchQnaAnswerDetail = async () => {
    try {
      setLoading(true);
      const response: any = await apiClient.get(`/uss/olh/qna/admin/selectQnaAnswerDetail.api?qaId=${id}`);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response: any = await apiClient.post('/uss/olh/qna/admin/updateQnaAnswer.api', payload);
      if (response.resultCode === 'SUCCESS') {
